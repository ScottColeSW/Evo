...
class Simulation:
    ...
    async def _install_chief(self, tribe: "Tribe") -> None:
        ...
        itself rather than scripted from outside it."""
        result = await elect_chief(self.client, tribe.model, tribe.name)
    ...
    def _prepare_turn(self, tribe: Tribe) -> tuple[dict, dict]:
        ...
        base_prompt = get_prime_consciousness_prompt(tribe.name, tribe.model, tribe.chief_name, tribe.chief_philosophy)
